...
{ 
  ...
  analysisManager->SetFileName("B5 Data");

  // Book histograms, ntuple
  //
  
  // Creating 1D histograms, second one for energy deposit
  analysisManager
    ->CreateH1("Chamber1","Boron Target # Hits", 50, 0., 5); // h1 Id = 0
  
  analysisManager
	  ->CreateH1("Chamber1 Energy", "Boron Target Hit Energies", 50, 0., 1*eV); //h1 ID = 1?

  analysisManager
	  ->CreateH1("Chamber1 Path Length", "Path Length Through Boron", 50, 0., 25 * mm); //h1 ID = 2?

  // Creating 2D histograms
  analysisManager                                                
    ->CreateH2("Chamber1 XY","Boron target X vs Y",           // h2 Id = 0
               50, -10., 10, 50, -10., 10.); 
  //analysisManager                                                
