...
G4VPhysicalVolume* B5DetectorConstruction::Construct()
{
  ...
  //PE Sphere with hole surrounding target
  //Max Angle corresponds to ArcSin(2/3)
  //Placed distance r*cos(41.8) from tube
  G4ThreeVector petargetspherepos = G4ThreeVector(0, 0, 2.24 * cm);
  G4double petargetsphereinnrad = 1 * cm;
  G4double petargetsphereoutrad = 3 * cm;
  G4double petargetspheremintheta = 0*deg;
  G4double petargetspheremaxtheta = (180-41.8)* deg;
  ...
  //PE Sphere with hole surrounding source
  //Min Angle corresponds to ArcSin(2/3)
  //Placed distance r*cos(41.8) from tube
  G4ThreeVector pesourcespherepos = G4ThreeVector(0, 0, -12.24 * cm);
  G4double pesourcesphereinnrad = 1 * cm;
  G4double pesourcesphereoutrad = 3 * cm;
  G4double pesourcespheremintheta = 41.8 * deg;
  G4double pesourcespheremaxtheta = 180 * deg;
  G4Sphere* peSourceSphereShape =
	  new G4Sphere("peSourceSphere",
		  pesourcesphereinnrad, pesourcesphereoutrad,
		  0 * deg, 360 * deg,
		  pesourcespheremintheta, pesourcespheremaxtheta);
  G4LogicalVolume* logicpeSource=
	  new G4LogicalVolume(peSourceSphereShape,
		  pe_mat,
		  "pe_source_sphere");
  new G4PVPlacement(0,
	  pesourcespherepos,
  ...
  //Shape 3
  //given same positiion as surrounding sphere
  ...
  logicShape3 =
    new G4LogicalVolume(solidShape3,
                        sphere_mat,
                        "boron_sphere");
  G4ThreeVector pos3 = petargetspherepos;
  new G4PVPlacement(0,
                        pos3,
                        logicShape3,
                        "Shape3",
